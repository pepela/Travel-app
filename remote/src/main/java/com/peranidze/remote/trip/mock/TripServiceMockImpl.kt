...
class TripServiceMockImpl : TripService {
    ...
    val trips = listOf(
        TripModel(1L, "london", Date(1542490367181), Date(1582490367181), "comment is here"),
        ...
        TripModel(12L, "destination5", Date(1562290367181), Date(1562490367181), "comment is here"),
